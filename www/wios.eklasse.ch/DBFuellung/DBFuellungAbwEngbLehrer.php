...
$sql_befehl = "UPDATE sv_AbwesenheitenKompakt SET Kommentar='$Kommentar', Abwesenheitsdauer='$Dauer',Lehrer='$Lehrer' Where Kursname='$Kursname' and Datum='$Datum' and SchülerID='$ID'   ";
