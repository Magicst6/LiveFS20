...
<button id="showTable" onClick="showTable1()">Tabelle anzeigen</button>	
...
Beschreibung*:<br>
		<input name="beschr" id="beschr"  width=100px  required="required">
		<br><br>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="modal-content1">
		...
		<form action="" method="post" enctype="multipart/form-data">
Beschreibung*:<br>
		<input name="beschrsm" id="beschrsm" width=100px  required="required">
		<br><br>
