...
$sel2= '" Group by Nachname';
 $isEntryUpd1 = "UPDATE sv_postmeta SET meta_value  = '$select$sel1$sel2' where post_id='18324' and meta_key='visualizer-db-query' ";
...
$sel2= '" Group by Nachname';
 $isEntryUpd2 = "UPDATE sv_postmeta SET meta_value  = '$select$sel1$sel2' where post_id='18337' and meta_key='visualizer-db-query' ";
...
<button type="button" id="loadVals" onclick="reloadpage1()">Noten anzeigen</button>  
...
<script>
	 ...
	 function test1(){
            ...
            xmlhttp.open("GET","/wp-content/themes/structr/Page_Scripts/GetAbwValues.php?q=" +  document.getElementById( "Kursname" ).value + "&s=" + document.getElementById( "semDB" ).value,true);
